...
namespace AFPv2
{
    ...
    public partial class Form1 : Form
    {
        ...
        public void SettingsMake()
        {
            ...
            //2017/1  - 2020 11 22 (23日からIMX253に交換。IDも１－＞１１１
            sett.Text = "IDS UI-3370CP-NIR";
            sett.ID = 111;                 //ID 全カメラの中のID　保存ファルイの識別にも使用。FishEye:0  MT3Wide:4  MT3Fine:8  MT3SF:12 等々
            sett.NoCapDev = 111;
            sett.CameraType = "IDS";     //カメラタイプ： IDS Basler AVT IS analog
            ...
            //sett.Flipmode = OpenCvSharp.FlipMode.X;
            //sett.IP_GIGE_Camera = "192.168.1.151"; //GIGE Camera only.
            sett.Width  = 2608; // 652; //Max 659    4の倍数でメモリ確保される。
            sett.Height = 2608; // 949; //Max 494    約2.2MB／fr
            sett.FocalLength = 2.7;      //[mm] Fuji FE185C086HA-1  fl=2.7mm f1.8
